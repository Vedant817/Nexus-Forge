...
async function main(): Promise<void> {
  ...
  try {
    ...
    assert(names.includes('20260922290000_pilot_loop'), 'pilot loop migration was applied in order')
    assert(names.includes('20260922300000_evidence_lifecycle'), 'evidence lifecycle migration was applied in order')
    assert(names.includes('20260922310000_profiles_templates'), 'profiles/templates migration was applied in order')
    assert(names.includes('20260922320000_artifact_review'), 'artifact review migration was applied in order')
    assert(names.includes('20260922330000_trigger_engine'), 'trigger engine migration was applied in order')
    assert(names.includes('20260922340000_finding_triage'), 'finding triage migration was applied in order')
    assert(names.includes('20260922350000_notifications_sharing'), 'notifications/sharing migration was applied in order')
    assert(names.includes('20260922360000_billing'), 'billing migration was applied in order')
    assert(names.includes('20260922370000_team_platform'), 'team platform migration was applied in order')
    assert(names.includes('20260922380000_verification'), 'verification migration was applied in order')
    assert(names.includes('20260922390000_enterprise'), 'enterprise migration was applied in order')
    assert(names.includes('20260922220000_data_transfer_containment'), 'data-transfer containment migration was applied in order')
